            ...
            <div className="">
              <div className="col-12 form-group mg-top">
                ...
                <input
                  ...
                  onChange={(event) => this.handleOnChageInput(event, "tenSp")}
                  name="tenSp"
              ...
              <div className="col-12 form-group mg-top">
                ...
                <input
                  ...
                  className="form-control"
                  placeholder="Nhập tên loại sản phẩm"
                  onChange={(event) => this.handleOnChageInput(event, "hangSx")}
                  name="hangSx"
              ...
              <div className="col-6 form-group mg-top">
                ...
                <input
                  ...
                  onChange={(event) =>
                    this.handleOnChageInput(event, "giaNhap")
                  }
                  name="giaNhap"
              ...
              <div className=" col-12 flexNewEdit">
                <div className="col-sm-12 col-md-3 col-sm-6 form-group  mg-top">
                  ...
                  <select
                    ...
                    class="form-select"
                    onChange={(event) =>
                      this.handleOnChageInput(event, "idDanhSach")
                    }
                    value={this.state.idDanhSach}
                  >
                ...
                <div className="col-sm-12 col-md-3 form-group mg-top">
                  ...
                  <input
                    ...
                    placeholder="Nhập tên loại sản phẩm"
                    onChange={(event) =>
                      this.handleOnChageInput(event, "giaSanPham")
                    }
                    name="giaSanPham"
                ...
                <div className="col-sm-12 col-md-3 form-group mg-top">
                  ...
                  <input
                    ...
                    className="form-control"
                    placeholder="Nhập tên loại sản phẩm"
                    onChange={(event) => this.handleOnChageInput(event, "sale")}
                    name="name"
                ...
                <div className="col-sm-12 col-md-3 form-group mg-top">
                  ...
                  <input
                    ...
                    placeholder="Nhập tên loại sản phẩm"
                    onChange={(event) =>
                      this.handleOnChageInput(event, "soLuong")
                    }
                    name="name"
              ...
              <div className=" col-sm-4 col-md-3 row">
                <div className=" form-group mg-top">
                  ...
                  <div className="upload-image">
                    <label htmlFor="taianh" className="text_image">
                    ...
                    {lenghtImage <= 10 ? (
                      <input
                        ...
                        hidden
                        type="file"
                        onChange={(e) => this.handleImage2(e, "image")}
                        multiple
                      />
                    ) : null}
                  </div>
