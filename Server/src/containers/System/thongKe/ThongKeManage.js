...
class ThongKeManage extends Component {
  ...
  giaTienSanPham = (id) => {
    ...
    giaTien = giaTien.toLocaleString("it-IT", {
      style: "currency",
      currency: "VND",
    });
    return giaTien;
  ...
  tienLaiSanPham = () => {
    ...
    return tienLai.toLocaleString("it-IT", {
      style: "currency",
      currency: "VND",
    });
  };
  ...
  render() {
    console.log(this.state.chonNgay, "ngày tháng năm");
        ...
        <div className="col-12 " style={{ display: "flex" }}>
          <div className="col-2">
            <select
              name="roleID"
              class="form-control"
              onChange={(event) => this.handleChonThongKe(event)}
              value={this.state.chonThongKe}
            >
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  onChange={(event) => this.handleOnChageInputNgay(event)}
                  value={this.state.ngayThangNam}
                />
              </div>
              <div
                className="col-4"
              ...
              >
                ...
                <input
                  type="date"
                  className="form-control"
                  onChange={(event) => this.handleOnChageInputDenNgay(event)}
                  value={this.state.denNgayThangNam}
                />
              </div>
              <div className="col-2">
                <button
                  onClick={() => this.clickHear()}
            ...
            >
              ...
              >
                ...
                <input
                  type="date"
                  className="form-control"
                  onChange={(event) => this.handleOnChageInputChonNgay(event)}
                  value={
                    this.state.chonNgay ? this.state.chonNgay.toString() : ""
                  }
                />
              </div>
            </div>
                      ...
                      >
                        {item.ipSanPham && (
                          <img
                            ...
                            src={this.showImage(item.ipSanPham)}
                          />
                        )}
                      </td>
                      <td>{this.gettenSanPham(item.ipSanPham)}</td>
                      <td style={{ color: "red" }}>
